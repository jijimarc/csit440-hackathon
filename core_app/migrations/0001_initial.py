# Generated by Django 5.2.6 on 2026-04-08 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_status', models.CharField(choices=[('STUDENT', 'Student'), ('ALUMNI', 'Alumni')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
        ...
        migrations.CreateModel(
            name='Alumni',
            fields=[
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core_app.customer')),
                ('year_of_graduation', models.DateField()),
                ('valid_personal_id', models.ImageField(blank=True, null=True, upload_to='alumni_ids/')),
